          ...
          <div className="mt-3 rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            {selectedRow ? (
              <div className="mt-3 grid gap-3 sm:grid-cols-2">
                ...
                <div><div className="text-xs uppercase tracking-wide text-slate-500">Category</div><div className="mt-1 text-sm font-medium text-slate-900">{EXPENSE_CATEGORY_LABELS[selectedRow.category]}</div></div>
                ...
                <div><div className="text-xs uppercase tracking-wide text-slate-500">Amount</div><div className="mt-1 text-sm font-medium text-slate-900">{formatExpensesJPY(selectedRow.amount)}</div></div>
