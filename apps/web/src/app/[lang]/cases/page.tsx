...
const I18N: Record<Lang, NavT> = {
  ...
  en: {
    ...
    title: "Case studies",
    lead: "Stories of real-world improvements after adoption.",
    ctaTrial: "Start free",
  },
  "zh-CN": {
...
const homeHref = `/${lang}`;
  ...
  return (
      <>
        <MarketingTopBar active="auto" lang={lang} nav={topNav as any} subtitle="Cases" />
