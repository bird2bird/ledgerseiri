...
> = {
  ...
  ja: {
    ...
    hero: {
      ...
      title2: "経営管理の形に整理",
      lead: "Amazon注文データおよびCSV注文ファイルの取り込み、SKU別販売分析、在庫管理、銀行明細との照合を支援します。Seller CentralのログインID・パスワードは取得しません。",
      ctaPrimary: "👉 無料で始める",
      ctaSecondary: "👉 解決できる課題を見る",
      note: "※ 本サービスは経営管理を支援するツールです。最終的な申告は税理士等の専門家にご確認ください",
      badges: ["Amazon SP-API連携", "CSV注文データ取込", "注文データ取込", "SKU別販売分析", "在庫管理", "銀行明細照合"],
    },
    ...
    blocks: {
      ...
      b: {
        ...
        desc: "Amazon注文データまたはCSV注文ファイルを取り込み、注文別・SKU別の売上確認と販売数量の整理を支援します。",
    ...
    grid: {
      ...
      cards: [
        ...
        { title: "経営ダッシュボード", desc: "CSV注文データ、売上、支出、在庫、インポート履歴を確認し、経営状況を把握します。" },
    ...
    pricing: {
      ...
      plans: [
        { name: "Starter", price: "¥980/月", items: ["単一ストア", "CSV注文データ取込", "基本ダッシュボード"] },
