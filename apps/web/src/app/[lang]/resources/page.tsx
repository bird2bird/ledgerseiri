...
const I18N: Record<Lang, NavT> = {
  ja: {
    ...
    title: "資料一覧",
    lead: "導入に役立つ資料・テンプレ・解説をまとめました（ダウンロード導線）。",
    ctaTrial: "無料で体験を開始",
  },
  en: {
    ...
    title: "Resources",
    lead: "Download guides, templates and explainers to make decisions faster.",
    ctaTrial: "Start free",
  },
  "zh-CN": {
...
const homeHref = `/${lang}`;
  ...
  return (
      <>
        <MarketingTopBar active="auto" lang={lang} nav={topNav as any} subtitle="Resources" />
